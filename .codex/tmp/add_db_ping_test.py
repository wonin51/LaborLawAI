...
test_dir = root / 'src/test/java/com/laborlaw/ragkbdemo/controller'
test_dir.mkdir(parents=True, exist_ok=True)
(test_dir / 'DbPingControllerTest.java').write_text('''package com.laborlaw.ragkbdemo.controller;
...
''', encoding='utf-8')
print(test_dir / 'DbPingControllerTest.java')
